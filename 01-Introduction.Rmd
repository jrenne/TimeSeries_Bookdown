...
The Autoregressive conditional heteroskedasticity process---studied in Section \@ref(ARCHGARCH)---is an example of shock that satisfies the MDS definition but that is not i.i.d.:
$$
