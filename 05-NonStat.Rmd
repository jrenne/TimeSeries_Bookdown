...
:::{.theorem #cvgceunitroot name="Convergence results when $\phi=1$"}
...
```{r figInflr,echo=FALSE, fig.align = 'left-aligned', out.width = "95%", fig.cap = "US Inflation and short-term nominal rates."}
