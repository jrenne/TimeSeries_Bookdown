...
The relationship between $\{y_t\}$ and $\{\tilde{y}_t^{(s)}\}$ defines the **dynamic multiplier**. The latter is denoted by $\frac{\partial y_t}{\partial \varepsilon_{s}}$ and is such that:
$$
